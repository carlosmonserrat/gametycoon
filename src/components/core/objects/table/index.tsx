...
const TableObject = (): JSX.Element => {
    ...
    return (
        <svg width="140" height="95" viewBox="0 0 140 95" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M117.282 44.1802C114.311 41.3865 107.343 37.1108 107.157 37.33C107.155 37.3808 107.154 37.3867 107.153 37.3418C107.153 37.337 107.154 37.333 107.157 37.33C107.185 36.5302 107.341 24.6108 107.341 24.6108L117.094 29.5077L117.282 44.1802Z" fill="#363636"/>
            ...
            <defs>
                <filter id="filter0_d_236_10" x="17" y="49.7764" width="35.7073" height="43.8988" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
